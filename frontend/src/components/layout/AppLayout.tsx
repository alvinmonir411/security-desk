...
export const AppLayout: React.FC<AppLayoutProps> = ({ children }) => {
  ...
  const rawNavItems = [
    ...
    { id: 'profile', label: 'My Profile', icon: User, roles: ['SECURITY_GUARD'] },
    { id: 'deployment', label: 'Roster Maker', icon: Layers, roles: ['MANAGER', 'SUPERVISOR', 'AGM', 'DGM'] },
    { id: 'matrix', label: 'Guards Directory & Duty Matrix', icon: CalendarDays, roles: ['MANAGER', 'AGM', 'DGM', 'SUPERVISOR'] },
